...
public class DataBaseUtil {
            ...
            String username, String pwd)
    {
        ...
        try
        {
            ...
            while (result.next())
            {
                ...
                bean.setList(getTablesProperty(bean.getTabName(), driver, url, username, pwd));
	...
	public static Connection getConnection(String driver, String url, String userName,
            String pwd)
    {
        log.debug("connection to database the params is: Driver["
        ...
        try
        {
            ...
            while (result.next())
            {
                ...
                if(type.contains("("))
                {
                    ...
                    try
                    {
                        bean.setLength(Integer.parseInt(type.substring(type.indexOf("(")+1, type.indexOf(")")).trim()));
                    }
